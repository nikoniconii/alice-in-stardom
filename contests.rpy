...
label week1contest:
    ...
    m up frowntalk "I didn’t ask for an apology. I asked for a word of gratitude."
    ...
    m "Oh, and they do a better dance than you. Trust me."
    ...
    show mary up smile summer at center with dissolve
    ...
    show katja smile at right
    show taylor up frown summer at left
    with dissolve
    ...
    k talk "A friend of mine wants to sign the girl into his record company after hearing her Mary had a Little Lamb last week, can you believe it?{/i}"
    ...
    t frowntalk "I am not fighting. I just think I’m not necessarily less skilled than her."
    ...
    ann "{i}Which one of the stylists let him walk out on stage with a shirt that clashes that horribly with the mult-colored flower ring around her neck?{/i}"
    ann "{i}I suppose his stubborn attitude does give him a unique kind of charisma, though. Once again, she opts for minimal background music while she sings, opening the song with smooth falsetto.{/i}"
    ann "{i}Would it be accurate to call his singing wailing? That would give it a negative connotation, would it? But I mean it in a good way, actually. There is just so much emotion in the way she sings.{/i}"
    ...
    ann "{i}He has so much control at even pitches difficult for me to reach, switching easily to lower tones for drastic, powerful effects.{/i}"
...
label week1win:
    ...
    ann "{i}I remember watching a show like this on TV. Of course, you’d want to see the superstar in all his glory, singing so brilliantly that it nearly stops your heart. But what you feel is that you must worship him.{/i}"
...
label week2contest:
    ...
    a "The lesson that I really am that bad?"
    
    m "All our scores were close. Just because you scored lowest doesn't mean you were terrible."
    ...
    a "{i}Shortly after Mary heads off towards the stage, a weary-looking Taylor comes in through the door. She was missing from our apartment complex since this morning, and this isn’t the first time she has done it.{/i}"
    a "{i}Whenever she comes back, she always looks worse than before she left. I really want to ask if something is wrong, but that would be sort of prying, right?{/i}"
    a "{i}At least she changed into a different shirt for the techno theme this week - a bright yellow tee with cyan and fuchsia stripes.{/i}"
